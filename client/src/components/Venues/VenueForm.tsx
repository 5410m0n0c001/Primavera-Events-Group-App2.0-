...
const VenueForm: React.FC<VenueFormProps> = ({ venue, onSave, onCancel }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center pt-10 z-50 overflow-y-auto">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl m-4 p-6 relative">
                <div className="max-h-[80vh] overflow-y-auto pr-2 custom-scrollbar">
                    <h2 className="text-2xl font-bold mb-6 text-gray-800 sticky top-0 bg-white z-10 py-2">
